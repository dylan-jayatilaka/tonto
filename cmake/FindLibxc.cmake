...
if(NOT LIBXC_FOUND)
  ...
  find_path(LIBXC_INCLUDE_DIRS NAMES xc.h xc_funcs.h 
      xc_f90_lib_m.mod xc_f90_types_m.mod
      libxc_funcs_m.mod xc_f03_lib_m.mod
      HINTS ${LIBXC_INCLUDE_DIR})
  
  find_library(LIBXC_C_LIBRARY xc 
      HINTS ${LIBXC_LIBRARY})
  list(APPEND LIBXC_LIBRARIES ${LIBXC_C_LIBRARY})

  find_library(LIBXC_F90_LIBRARY xcf90
      HINTS ${LIBXC_LIBRARY})
  list(APPEND LIBXC_LIBRARIES ${LIBXC_F90_LIBRARY})

  find_library(LIBXC_F03_LIBRARY xcf03
      HINTS ${LIBXC_LIBRARY})
  list(APPEND LIBXC_LIBRARIES ${LIBXC_F03_LIBRARY})
