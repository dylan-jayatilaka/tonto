...
if("${CMAKE_Fortran_COMPILER_ID}" MATCHES "Intel")
    ...
    if(WIN32)
        ...
        set(HOST_FLAG "-xHost")
        set(DEBUG_FLAGS "-g -warn all -traceback -check all -debug -DUSE_PRECONDITIONS -DDEBUG")
...
elseif("${CMAKE_Fortran_COMPILER_ID}" MATCHES "GNU")
    ...
    set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -fallow-invalid-boz -fno-sign-zero -ffree-line-length-none")
