...
if("${CMAKE_Fortran_COMPILER_ID}" MATCHES "Intel")
    ...
    if(WIN32)
        set(HOST_FLAG "")
        set(DEBUG_FLAGS "/Od /warn:all /traceback /check:bounds -DUSE_PRECONDITIONS")
        set(RELEASE_FLAGS "/O3 /libs:static /Qunroll /warn:none -DUSE_ERROR_MANAGEMENT")
    else()
        set(HOST_FLAG "-xHost")
        set(DEBUG_FLAGS "-g -warn all -traceback -check all -debug all -DUSE_PRECONDITIONS")
        set(RELEASE_FLAGS "-O3 -warn none -DUSE_ERROR_MANAGEMENT")
    endif()
elseif("${CMAKE_Fortran_COMPILER_ID}" MATCHES "PGI")
    set(COMPILER "PGI_pgfortran")
    set(HOST_FLAG "-ta=host")
    set(DEBUG_FLAGS "-O0 -traceback -Mbounds -DUSE_PRECONDITIONS")
...
elseif("${CMAKE_Fortran_COMPILER_ID}" MATCHES "GNU")
    ...
    set(DEBUG_FLAGS "-O0 -Wall -g -fbacktrace -fcheck=bounds -DUSE_PRECONDITIONS")
    set(RELEASE_FLAGS "-O3 -funroll-loops -finline-functions -DUSE_ERROR_MANAGEMENT")
elseif("${CMAKE_Fortran_COMPILER_ID}" MATCHES "NAG")
    set(COMPILER "NAG_nagfor")
    set(HOST_FLAG "-dusty -kind=byte -maxcontin=1023")
    set(DEBUG_FLAGS "-O0 -g -gline -mtrace -C=all   -DUSE_PRECONDITIONS")
    ...
    set(DEBUG_FLAGS   "-g  -DUSE_PRECONDITIONS")
