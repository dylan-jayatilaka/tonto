...
#
#*******************************************************************************
# $Id: compile_mod.pl 4396 2014-05-31 10:07:16Z dylan_ $
#
...
$cmp      || do {$argerr=1; warn "Error : -cmp flag not supplied.\n"};
$fc       || do {$argerr=1; warn "Error : -fc flag not supplied.\n"};
@provides || do {$argerr=1; warn "Error : -provides flag not supplied.\n"};
@requires || do {$argerr=1; warn "Error : -requires flag not supplied.\n"};
