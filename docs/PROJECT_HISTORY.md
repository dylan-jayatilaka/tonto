# Project history — how Tonto's build and translator came to be

Background, not current work. This file holds the narrative that used to live in
`CLAUDE.md`: why the ANTLR4 translator exists, what the twelve milestones were, and what
each one found. It is kept because the reasoning explains why the code looks as it does.
